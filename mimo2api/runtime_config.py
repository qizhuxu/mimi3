...
FIELDS: dict[str, ConfigField] = {
    ...
    "lifecycle.monitor_interval_seconds": ConfigField("lifecycle.monitor_interval_seconds", "MIMO_LIFECYCLE_MONITOR_INTERVAL_SECONDS", 300, "int", label="监测间隔", group="生命周期策略"),
    ...
    "lifecycle.instance_max_lifetime_seconds": ConfigField("lifecycle.instance_max_lifetime_seconds", "MIMO_LIFECYCLE_INSTANCE_MAX_LIFETIME_SECONDS", 14400, "int", label="\u5b9e\u4f8b\u6700\u5927\u5bff\u547d(\u79d2)", group="\u751f\u547d\u5468\u671f\u7b56\u7565"),
    "lifecycle.daily_create_limit": ConfigField("lifecycle.daily_create_limit", "MIMO_LIFECYCLE_DAILY_CREATE_LIMIT", 1, "int", label="\u6bcf\u65e5\u521b\u5efa\u4e0a\u9650", group="\u751f\u547d\u5468\u671f\u7b56\u7565"),
