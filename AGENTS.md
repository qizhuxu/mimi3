...
This project is indexed by GitNexus as **mimi3** (427 symbols, 845 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
